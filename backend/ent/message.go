...
func (*Message) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case message.FieldImageUrls, message.FieldMetadata:
			values[i] = new([]byte)
		case message.FieldCostUsd:
			values[i] = new(sql.NullFloat64)
		case message.FieldID, message.FieldConversationID, message.FieldTokensUsed:
			values[i] = new(sql.NullInt64)
		case message.FieldRole, message.FieldContent, message.FieldContentType, message.FieldModel:
