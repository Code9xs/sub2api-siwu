...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.CompositeModelRoute, c.Conversation, c.ErrorPassthroughRule, c.Group,
		c.IdempotencyRecord, c.IdentityAdoptionDecision, c.Message, c.PaymentAuditLog,
...
type (
	hooks struct {
		...
		ChannelMonitorRequestTemplate, CompositeModelRoute, Conversation,
		ErrorPassthroughRule, Group, IdempotencyRecord, IdentityAdoptionDecision,
		Message, PaymentAuditLog, PaymentOrder, PaymentProviderInstance,
