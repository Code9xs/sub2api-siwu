...
// was not loaded in eager-loading.
func (e APIKeyEdges) ConversationsOrErr() ([]*Conversation, error) {
	if e.loadedTypes[3] {
...
// QueryConversations queries the "conversations" edge of the APIKey entity.
func (_m *APIKey) QueryConversations() *ConversationQuery {
	return NewAPIKeyClient(_m.config).QueryConversations(_m)
}
