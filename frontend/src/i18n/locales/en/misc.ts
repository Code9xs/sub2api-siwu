export default {
  ...
  chat: {
    ...
    emptyDescription: 'Select a model and start typing to chat with AI.',
    noKeyTitle: 'No API Keys Available',
    noKeyDescription: 'You need to create an API key first before you can use the chat feature. Go to the Keys page to create one.',
    createKey: 'Create API Key',
    imageMode: 'Image Generation Mode',
    imagePlaceholder: 'Describe the image you want to generate...',
    imageHint: 'Describe your image prompt, then press Enter to generate',
