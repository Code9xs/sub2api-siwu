...
func (_c *ConversationCreate) SetAPIKeyID(v int64) *ConversationCreate {
...
func (_c *ConversationCreate) SetAPIKey(v *APIKey) *ConversationCreate {
...
func (_c *ConversationCreate) check() error {
	...
	if _, ok := _c.mutation.APIKeyID(); !ok {
		return &ValidationError{Name: "api_key_id", err: errors.New(`ent: missing required field "Conversation.api_key_id"`)}
	}
	if _, ok := _c.mutation.Title(); !ok {
	...
	if len(_c.mutation.APIKeyIDs()) == 0 {
		return &ValidationError{Name: "api_key", err: errors.New(`ent: missing required edge "Conversation.api_key"`)}
	}
	return nil
}
...
func (_c *ConversationCreate) createSpec() (*Conversation, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.APIKeyIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   conversation.APIKeyTable,
			Columns: []string{conversation.APIKeyColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetAPIKeyID sets the "api_key_id" field.
func (u *ConversationUpsert) SetAPIKeyID(v int64) *ConversationUpsert {
	u.Set(conversation.FieldAPIKeyID, v)
	return u
}

// UpdateAPIKeyID sets the "api_key_id" field to the value that was provided on create.
func (u *ConversationUpsert) UpdateAPIKeyID() *ConversationUpsert {
	u.SetExcluded(conversation.FieldAPIKeyID)
	return u
}
...
func (u *ConversationUpsert) ClearLastMessageAt() *ConversationUpsert {
	u.SetNull(conversation.FieldLastMessageAt)
	return u
}
...
// SetAPIKeyID sets the "api_key_id" field.
func (u *ConversationUpsertOne) SetAPIKeyID(v int64) *ConversationUpsertOne {
	return u.Update(func(s *ConversationUpsert) {
		s.SetAPIKeyID(v)
	})
}
...
// UpdateAPIKeyID sets the "api_key_id" field to the value that was provided on create.
func (u *ConversationUpsertOne) UpdateAPIKeyID() *ConversationUpsertOne {
	return u.Update(func(s *ConversationUpsert) {
		s.UpdateAPIKeyID()
	})
}
...
// ClearLastMessageAt clears the value of the "last_message_at" field.
func (u *ConversationUpsertOne) ClearLastMessageAt() *ConversationUpsertOne {
	return u.Update(func(s *ConversationUpsert) {
...
// SetAPIKeyID sets the "api_key_id" field.
func (u *ConversationUpsertBulk) SetAPIKeyID(v int64) *ConversationUpsertBulk {
	return u.Update(func(s *ConversationUpsert) {
		s.SetAPIKeyID(v)
	})
}
...
// UpdateAPIKeyID sets the "api_key_id" field to the value that was provided on create.
func (u *ConversationUpsertBulk) UpdateAPIKeyID() *ConversationUpsertBulk {
	return u.Update(func(s *ConversationUpsert) {
		s.UpdateAPIKeyID()
	})
}
...
// ClearLastMessageAt clears the value of the "last_message_at" field.
func (u *ConversationUpsertBulk) ClearLastMessageAt() *ConversationUpsertBulk {
	return u.Update(func(s *ConversationUpsert) {
		s.ClearLastMessageAt()
	})
}
