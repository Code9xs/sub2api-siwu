...
func (_u *ConversationUpdate) SetAPIKeyID(v int64) *ConversationUpdate {
	_u.mutation.SetAPIKeyID(v)
	return _u
}

// SetNillableAPIKeyID sets the "api_key_id" field if the given value is not nil.
func (_u *ConversationUpdate) SetNillableAPIKeyID(v *int64) *ConversationUpdate {
	if v != nil {
		_u.SetAPIKeyID(*v)
	}
	return _u
...
func (_u *ConversationUpdate) SetAPIKey(v *APIKey) *ConversationUpdate {
...
func (_u *ConversationUpdate) ClearAPIKey() *ConversationUpdate {
...
func (_u *ConversationUpdate) check() error {
	...
	if _u.mutation.APIKeyCleared() && len(_u.mutation.APIKeyIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Conversation.api_key"`)
	}
	return nil
}
...
// SetAPIKeyID sets the "api_key_id" field.
func (_u *ConversationUpdateOne) SetAPIKeyID(v int64) *ConversationUpdateOne {
	_u.mutation.SetAPIKeyID(v)
	return _u
}

// SetNillableAPIKeyID sets the "api_key_id" field if the given value is not nil.
func (_u *ConversationUpdateOne) SetNillableAPIKeyID(v *int64) *ConversationUpdateOne {
	if v != nil {
		_u.SetAPIKeyID(*v)
	}
	return _u
...
// SetAPIKey sets the "api_key" edge to the APIKey entity.
func (_u *ConversationUpdateOne) SetAPIKey(v *APIKey) *ConversationUpdateOne {
	return _u.SetAPIKeyID(v.ID)
}
...
// ClearAPIKey clears the "api_key" edge to the APIKey entity.
func (_u *ConversationUpdateOne) ClearAPIKey() *ConversationUpdateOne {
	_u.mutation.ClearAPIKey()
	return _u
}
