...
func (_u *APIKeyUpdate) AddConversationIDs(ids ...int64) *APIKeyUpdate {
	_u.mutation.AddConversationIDs(ids...)
	return _u
}

// AddConversations adds the "conversations" edges to the Conversation entity.
func (_u *APIKeyUpdate) AddConversations(v ...*Conversation) *APIKeyUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ConversationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   apikey.ConversationsTable,
			Columns: []string{apikey.ConversationsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddConversationIDs adds the "conversations" edge to the Conversation entity by IDs.
func (_u *APIKeyUpdateOne) AddConversationIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.AddConversationIDs(ids...)
	return _u
}

// AddConversations adds the "conversations" edges to the Conversation entity.
func (_u *APIKeyUpdateOne) AddConversations(v ...*Conversation) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearConversations clears all "conversations" edges to the Conversation entity.
func (_u *APIKeyUpdateOne) ClearConversations() *APIKeyUpdateOne {
	_u.mutation.ClearConversations()
	return _u
}

// RemoveConversationIDs removes the "conversations" edge to Conversation entities by IDs.
func (_u *APIKeyUpdateOne) RemoveConversationIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.RemoveConversationIDs(ids...)
	return _u
}

// RemoveConversations removes "conversations" edges to Conversation entities.
func (_u *APIKeyUpdateOne) RemoveConversations(v ...*Conversation) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
